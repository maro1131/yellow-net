...
def dashboard():
    ...
    conn.close()
    return render_template('dashboard.html', user=username, friends=friends, videos=videos, notifications=notifications)
...
def add_friend():
    ...
    if friend_name == username: return redirect(url_for('dashboard'))
